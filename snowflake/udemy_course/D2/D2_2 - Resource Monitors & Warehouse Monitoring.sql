...
WHERE WAREHOUSE_NAME = 'DATA_ENGINEER_WH';
...
CREATE RESOURCE MONITOR DATA_ANALYSIS_WAREHOUSE_RESOURCE_MONITOR
WITH
    CREDIT_QUOTA = 1 
    TRIGGERS 
...
ALTER WAREHOUSE "DATA_ENGINEER_WH" SET RESOURCE_MONITOR = "DATA_ANALYSIS_WAREHOUSE_RESOURCE_MONITOR";

ALTER WAREHOUSE DATA_ENGINEER_WH SET WAREHOUSE_SIZE=XXXLARGE;

SELECT * FROM LINEITEM;

-- Resize warehouse to xsmall
ALTER WAREHOUSE DATA_ENGINEER_WH SET WAREHOUSE_SIZE=XSMALL;
