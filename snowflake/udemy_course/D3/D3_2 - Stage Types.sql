...
CREATE OR REPLACE STAGE FILMS_STAGE;
...
SELECT
  ...
  $3
FROM
  @%FILMS (file_format => 'CSV_FILE_FORMAT');
...
SELECT
  ...
  $3
FROM
  @FILMS_STAGE (file_format => 'CSV_FILE_FORMAT', pattern=>'.*[.]csv') t;
...
SELECT
  ...
  $3
FROM
  @FILMS_STAGE/films.csv (file_format => 'CSV_FILE_FORMAT') t;
