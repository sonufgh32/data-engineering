...
SHOW WAREHOUSES LIKE 'DATA_ENGINEER_WH';
ALTER WAREHOUSE DATA_ENGINEER_WH SUSPEND;
ALTER WAREHOUSE DATA_ENGINEER_WH SET AUTO_RESUME=FALSE;
...
ALTER WAREHOUSE DATA_ENGINEER_WH RESUME IF SUSPENDED;
ALTER WAREHOUSE DATA_ENGINEER_WH SET AUTO_RESUME=TRUE;
...
ALTER WAREHOUSE DATA_ENGINEER_WH SUSPEND;
ALTER WAREHOUSE DATA_ENGINEER_WH RESUME;
